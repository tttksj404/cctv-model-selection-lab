...
from .zone_topology import DEFAULT_ZONE_ADJACENCY, JURISDICTION_ZONE_COUNT
...
def _adjacency(request: ZoneProbabilityRequest) -> dict[int, tuple[int, ...]]:
    ...
    elif request.zone_count == JURISDICTION_ZONE_COUNT:
        for left, right in DEFAULT_ZONE_ADJACENCY:
